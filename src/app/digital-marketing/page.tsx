...
const plans = [
  {
    ...
    name: 'Clinic Starter', tagline: 'Build online presence & attract local patients',
    price: '₹11,999', originalPrice: '₹15,000', savings: 'Save ₹3,001', period: '/month',
  ...
  },
  {
    ...
    name: 'Engagement Accelerator', tagline: 'For clinics targeting 30–50 new patient inquiries/month',
    price: '₹17,999', originalPrice: '₹22,000', savings: 'Save ₹4,001', period: '/month',
    ...
    features: [
      ...
      { text: 'Meta Ad Boosting (₹3,000 ad budget incl.)', bold: true },
  ...
  },
  {
    ...
    name: 'Lead Gen Machine', tagline: 'Full-stack patient acquisition for maximum OPD growth',
    price: '₹27,999', originalPrice: '₹35,000', savings: 'Save ₹7,001', period: '/month',
    ...
    features: [
      ...
      { text: 'Full Meta Ads (₹8,000 ad budget incl.)', bold: true },
    ...
    note: 'Best for clinics wanting maximum appointments',
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                <BadgeCheck size={15} /> Exclusively for Doctors &amp; Healthcare Professionals
              </motion.div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-base">Hospital / Multi-Specialty Clinic?</h3>
            ...
            <a href="https://wa.me/918160881461?text=Hi%20Epsilon%2C%20I%20need%20a%20custom%20hospital%20marketing%20plan" target="_blank" rel="noopener noreferrer"
